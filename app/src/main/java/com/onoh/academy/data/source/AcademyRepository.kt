...
import com.onoh.academy.data.source.local.entity.ContentEntity
...
import com.onoh.academy.data.source.remote.ApiResponse
import com.onoh.academy.data.source.remote.RemoteDataSource
import com.onoh.academy.data.source.remote.response.ContentResponse
import com.onoh.academy.data.source.remote.response.CourseResponse
import com.onoh.academy.data.source.remote.response.ModuleResponse
import com.onoh.academy.utils.AppExecutors
import com.onoh.academy.vo.Resource

class AcademyRepository private constructor(private val remoteDataSource: RemoteDataSource, private val localDataSource: LocalDataSource,
